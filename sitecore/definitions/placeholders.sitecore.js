...
export default function addPlaceholdersToManifest(manifest) {
  manifest.addPlaceholder(
    ...
    { name: 'jss-albums', displayName: 'Albums' },
    { name: 'jss-related-artists', displayName: 'RelatedArtists' },
    { name: 'jss-tracklist', displayName: 'Tracklist' },
    { name: 'jss-playlist', displayName: 'Playlist' },
